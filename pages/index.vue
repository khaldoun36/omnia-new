<template>
  ...
  <section class="testimonials full-width content-grid">
    ...
    <Vue3Marquee :duration="30" direction="reverse" class="marquee">
      <div
        class="testimonial-card v-stack v-stack-s"
        style="--v-gap: 16px"
        v-for="item in testimonilas"
